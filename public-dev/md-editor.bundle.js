...
var m=__webpack_require__(14),n=__webpack_require__(37),p=__webpack_require__(22),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.portal"):60106,u=q?Symbol["for"]("react.fragment"):60107,v=q?Symbol["for"]("react.strict_mode"):60108,w=q?Symbol["for"]("react.provider"):60109,x=q?Symbol["for"]("react.context"):60110,y=q?Symbol["for"]("react.async_mode"):60111,z=q?Symbol["for"]("react.forward_ref"):60112,A="function"===
...
*/
var ba=__webpack_require__(0),m=__webpack_require__(87),A=__webpack_require__(14),C=__webpack_require__(22),ea=__webpack_require__(59),fa=__webpack_require__(88),ha=__webpack_require__(49),ja=__webpack_require__(37);
  ...
  function MdEditor(props) {
    ...
    _this.handleChange = function (e) {
      ...
      if (!value && !value.length) {
        value = _this.initInnerHTML;
        _this.setState({ innerHTML: value });
      }
      /* 列表监听变化 */
      var $prg = _this.getSelectedParagraph$();
      var prgText = $prg.text();
      // console.log(prgText)
    ...
    _this.onFocus = function (e) {
      // 失败
      if (_this.state.innerHTML === _this.initInnerHTML) {
        // 第一次
        e.preventDefault();
        _this.initSelection(e);
      }
    };

    _this.initSelection = function (e) {
      var range = document.createRange();
    ...
    _this.onPaste = function (e) {
      e.stopPropagation();
      e.preventDefault();
      var clipboardData = e.clipboardData || window.clipboardData || e.originalEvent.clipboardData || window.prompt('在这里输入文本');
    ...
    _this.onKeyDown = function (e) {
      ...
      switch (e.keyCode) {
        ...
        case 221:
          ...
          break;
        case 13:
          var $prevPrg = _this.getSelectedParagraph$();
          if (ulPatt.test($prevPrg.text())) {
            setTimeout(function () {
              var $prg = _this.getSelectedParagraph$();
              var prevText = $prg.text();
              $prg.text('- ' + prevText);
    ...
    _this.getSelectedParagraph$ = function () {
      var cls = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'md-paragraph';

      var sel = window.getSelection();
      var $currElem = $(sel.anchorNode.parentElement);
      var $paragraph = $currElem.hasClass(cls) ? $currElem : $currElem.parents('.' + cls);
      return $paragraph;
    };

    _this.changeIndent = function () {
      var change = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;

      var $paragraph = _this.getSelectedParagraph$();
      var clsList = $paragraph[0].classList;
      var indentCls = 'indent-0',
          indent = 0;
      for (var i = 0; i < clsList.length; i++) {
        var curCls = clsList[i];
    ...
    _this.initInnerHTML = '<div class="md-paragraph"> </div>'; // 备用方案
    _this.state = {
      // innerHTML: '',
  ...
  _createClass(MdEditor, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'md-editor-app' },
        _react2.default.createElement('div', { className: 'md-view' }),
...
_reactDom2.default.render(_react2.default.createElement(MdEditor, null), document.getElementById('root'));
